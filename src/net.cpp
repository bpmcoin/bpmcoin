...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "BPMcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"pool.d3ep.com", "193.70.113.19"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"bpmcointools.com", "testnet-seed.bpmcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. BPMcoin is probably already running."), addrBind.ToString().c_str());
        else
